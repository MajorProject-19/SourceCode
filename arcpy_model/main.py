...
cluster_polygon_feature = "clusters_polygon_bgudi"
...
spatial_reference = "WGS 1984 UTM Zone 43N"
# classes for coef of runoff
coef_of_runoff_classes= {'Bareland':0.6 , 'Urban': 0.9,'Forest':0.2}

roads = ['twelth','thirteenth','third','tenth','sixteenth','seventh','seventeenth','second','eighth','TechRoadTwo','PatanagereRoadTwo','PatanagereRoadOne','twentyfirst','nineteenth']
#['Cubbon_road', 'KR_road', 'Rashtreeya_VidhayalayaRoad', 'RashtreeyaVidhalayaRoad', 'Mysore_Road_end', 'BullTempleRoad'] #['KR_road', 'Rashtreeya_VidhayalayaRoad', 'RashtreeyaVidhalayaRoad', 'Mysore_Road_end', 'BullTempleRoad'] #,'twelth','thirteenth','third','tenth','seventeenth','second','eighth','TechRoadTwo','PatanagereRoadTwo','PatanagereRoadOne','twentyfirst','nineteenth'] #['Cubbon_road', 'KR_road', 'Rashtreeya_VidhayalayaRoad', 'RashtreeyaVidhalayaRoad', 'Mysore_Road_end', 'BullTempleRoad']  
# vasanthpura_main_rd, vasanthpura_road, subramanyapuru_main_rd, subramanyapuru_main_rd2, puttalingaiah_rd,eighty_feet_road2, eighty_feetRoad, banashankari_50feetRoad, attimabe_road, gubbala_main_Rd

# 'twelth','thirteenth','third','tenth','sixteenth','seventh','seventeenth','second','eighth','TechRoadTwo','PatanagereRoadTwo','PatanagereRoadOne','twentyfirst','nineteenth'
# ['eighteenth', 'nineteenth', 'twentyfirst','PatanagereRoadOne', 'PatanagereRoadTwo', 'TechRoadOne', 'TechRoadTwo','eighth', 'eleventh', 'fifteenth', 'fifth', 'fouteenth', 'second', 'seventeenth', 'seventh', 'sixteenth', 'sixth', 'tenth', 'third','thirteenth', 'twelth']
# twentieth, fourth, ninth
catchment = [10,15]
...
# Step 7
		...
		intensity_mm_hr = 1.14*3.285  # mm 3.285 without climate change
		...
		# intensity_kotyari = (7.1*(30**0.2)*p30_24mm**0.33)/((tc_total/60)**0.71) # mm/hr
